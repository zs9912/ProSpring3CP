...
public class RestfulClientSample {
        private static final String URL_PREFIX = "http://localhost:8085/prospring3/";
	private static final String URL_GET_ALL_CONTACTS = URL_PREFIX+"restful/contact/listdata";
	private static final String URL_GET_CONTACT_BY_ID = URL_PREFIX+"restful/contact/{id}";
	private static final String URL_CREATE_CONTACT = URL_PREFIX+"restful/contact/create";
	private static final String URL_UPDATE_CONTACT = URL_PREFIX+"restful/contact/{id}";
	private static final String URL_DELETE_CONTACT = URL_PREFIX+"restful/contact/{id}";	
